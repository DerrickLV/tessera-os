...
**Mission:** Client proposals, scopes, staffing, fees, assumptions, and revisions.

**Primary inputs:** CRM context, approved boilerplate, fee schedules, prior proposals.

**Outputs:** Proposal draft; scope matrix; pricing worksheet; revision comparison.
